	...
	<!-- enctype="multipart/form-data" -->
		<table class="table table-condensed mt-4">
				...
				<td width="80%">
					<select name="upCg_code" id="upCg_code">
						...
						<c:forEach var="up" items="${upCgList}">
							<option value="${up.upCg_code}" <c:if test="${item.upCg_code eq up.upCg_code}">selected</c:if> >${up.upCg_name}</option>
						</c:forEach>
					</select>
					<span id="downCg">
			...
			<tr>
				...
				<td width="80%">
					<input type="text" name="pnum" id="pnum" value="<c:out value='${item.pnum}'/>" readonly class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%">
				...
				<td width="80%">
					<input type="text" name="pname" id="pname" value="<c:out value='${item.pname}'/>" class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%">
				...
				<td width="80%">
					<input type="text" name="pcompany" id="pcompany" value="<c:out value='${item.pcompany}'/>" class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%">
			...
			<tr>
				...
				<td width="80%">
					<input type="number" name="pqty" id="pqty" value="<c:out value='${item.pqty}'/>" min="1" max="100" class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%">
				...
				<td width="80%">
					<input type="number" name="price" id="price" value="<c:out value='${item.price}'/>" min="0" required class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%">
				...
				<td width="80%">
					<input type="number" name="saleprice" id="saleprice" value="<c:out value='${item.saleprice}'/>" min="0" required class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%">
				...
				<td width="80%">
					<textarea name="pcontent" id="pcontent" rows="5" cols="60" class="form-control"><c:out value='${item.pcontent}'/></textarea>
				</td>
			</tr>
			<tr>
				<td width="20%">
				...
				<td width="80%">
					<input type="number" name="point" id="point" value="<c:out value='${item.point}'/>" min="0" required class="form-control">
				</td>
			</tr>
			<tr>
